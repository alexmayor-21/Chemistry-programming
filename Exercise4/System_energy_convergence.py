"""
THE SAME AS System.py EXCEPT FOR CONVERGENCE CONDITION:
Convergence in this file is in terms of the fraction change in energy, which is obtained the optimised energy faster
but doesn't guarantee that all particles have reached their equilibrium position
"""
        ...
        while (abs(frac_change) > convergence_limit) or (steps < 500): 
            ...
            if frac_change > 0:
                ...
                if (steps % 100 == 0) and verbose:
                    print (u'{:<4} steps: U = {:.3E}, \u0394U / U = {:.3E}'.format(steps, self.potential, frac_change))
                steps += 1
